...
- **DB now has:** `standards` (21), `compliance_assets` (19), view `v_audit_packs` (115 rows), `products` (**20 rows** — 12 Phase-7 + 8 Phase-11; `audience` + `standard_ids` populated). Re-seed products: `python3 scripts/seed_products.py`; re-seed compliance: `python3 scripts/seed_compliance.py`.
